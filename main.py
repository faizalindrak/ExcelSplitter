...
class SplitApp(QWidget):
    ...
    def _build_mail_merge_card(self):
        ...
        recipient_path_row = QHBoxLayout()
        recipient_path_row.setSpacing(10)
        recipient_path_row.addWidget(self._labeled("Recipient Workbook", self.edit_recipient_path))
        recipient_path_row.addWidget(self.btn_browse_recipients, 0, Qt.AlignBottom)
        recipient_path_row.addStretch()
        layout.addLayout(recipient_path_row)

        recipient_meta_row = QHBoxLayout()
        recipient_meta_row.setSpacing(10)
        recipient_meta_row.addWidget(self._labeled("Sheet", self.cmb_recipient_sheet))
        recipient_meta_row.addWidget(self.btn_load_recipient_sheets, 0, Qt.AlignBottom)
        recipient_meta_row.addWidget(self._labeled("Header Row", self.spin_recipient_header_row))
        recipient_meta_row.addWidget(self.btn_load_recipient_headers, 0, Qt.AlignBottom)
        recipient_meta_row.addStretch()
        layout.addLayout(recipient_meta_row)

        recipient_columns = QGridLayout()
        recipient_columns.setHorizontalSpacing(10)
        recipient_columns.setVerticalSpacing(8)
        recipient_columns.addWidget(self._labeled("Key", self.cmb_recipient_key), 0, 0)
        recipient_columns.addWidget(self._labeled("To", self.cmb_recipient_to), 0, 1)
        recipient_columns.addWidget(self._labeled("CC", self.cmb_recipient_cc), 1, 0)
        recipient_columns.addWidget(self._labeled("BCC", self.cmb_recipient_bcc), 1, 1)
        recipient_columns.setColumnStretch(2, 1)
        layout.addLayout(recipient_columns)
        ...
        attachment_options = QHBoxLayout()
        attachment_options.setSpacing(10)
        attachment_options.addWidget(self.chk_attach_excel)
        attachment_options.addWidget(self.chk_attach_pdf)
        attachment_options.addStretch()
        layout.addLayout(attachment_options)

        send_options = QHBoxLayout()
        send_options.setSpacing(10)
        send_options.addWidget(self.chk_delay_delivery)
        send_options.addWidget(self._labeled("Minutes", self.spin_delay_minutes))
        send_options.addWidget(self.chk_throttle)
        send_options.addWidget(self._labeled("Seconds", self.spin_throttle_seconds))
        send_options.addWidget(self.btn_build_mail_preview, 0, Qt.AlignBottom)
        ...
        mail_actions.setSpacing(10)
        mail_actions.addWidget(self.btn_send_mail_merge)
        mail_actions.addWidget(self.btn_cancel_mail_merge)
        mail_actions.addStretch()
        layout.addLayout(mail_actions)
